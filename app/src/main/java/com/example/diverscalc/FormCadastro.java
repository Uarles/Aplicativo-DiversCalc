...
public class FormCadastro extends AppCompatActivity {
    ...
    String[] mensagens = {"preencha todos os campos","Cadrastro realizado com sucesso"};
    String usuarioID;
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    try {
                        ...
                        erro = "A senha tem que ter no minimo 6 caracteres";

                    } catch (FirebaseAuthUserCollisionException e){
                        erro = "Usuário existente, por favor tente outro";
    ...
    private void SalvarDadosUsuario(){
        ...
        documentReference.set(usuarios).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Log.d("database", "Sucesso so salvar os dados ");
            }
        });
